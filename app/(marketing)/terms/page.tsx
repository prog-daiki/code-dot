const TermsPage = () => {
  return (
    <div className="container mx-auto px-4 py-12">
      <h1 className="text-3xl md:text-4xl font-bold mb-8 text-center text-sky-700">利用規約</h1>
      <div className="prose prose-sm max-w-none bg-white p-8 rounded-lg shadow-lg border">
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4 text-sky-600 border-b-2 border-sky-200 pb-2">第1条（適用）</h2>
        <p>
        ...
        <p>本条に基づき行った行為によりユーザーに生じた損害について，一切の責任を負いません。</p>

        <h2 className="text-2xl font-semibold mt-8 mb-4 text-sky-600 border-b-2 border-sky-200 pb-2">第8条（退会）</h2>
        <p>ユーザーは，定める退会手続により，本サービスから退会できるものとします。</p>
        ...
        <p>
          本規約の解釈にあたっては，日本法を準拠法とします。 本規約の解釈にあたっては，日本法を準拠法とします。
